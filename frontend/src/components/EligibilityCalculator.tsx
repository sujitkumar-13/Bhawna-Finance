                ...
                <div className="box-border  gap-x-8 md:gap-x-12 grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-y-12">
                    ...
                    >
                        ...
                        <div className="box-border  space-y-4 md:space-y-6">
                            ...
                            <button className="text-white font-bold bg-[#111F3B]  text-center text-nowrap w-full mt-2 md:mt-4 px-0 py-3 md:py-3.5 rounded-lg hover:bg-slate-800 transition-colors duration-300 cursor-pointer text-sm md:text-base">
                    ...
                    >
                        ...
                        <div className="box-border  text-center py-10 md:py-12 flex-grow flex flex-col justify-center">
                            <motion.div
                                initial={{ scale: 0 }}
                                animate={{ scale: 1 }}
